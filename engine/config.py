...
class GameConfig:
    ...
    RACE_TRANSLATIONS = {
        # --- Classic Fantasy ---
        "Human":               {"zh": "人類",   "ja": "人間",       "es": "Humano"},
        "Elf":                 {"zh": "精靈",   "ja": "エルフ",     "es": "Elfo"},
        "Dwarf":               {"zh": "矮人",   "ja": "ドワーフ",   "es": "Enano"},
        "Halfling":            {"zh": "半身人", "ja": "ハーフリング", "es": "Mediano"},
        "Half-Orc":            {"zh": "半獸人", "ja": "ハーフオーク", "es": "Semiorco"},
        "Tiefling":            {"zh": "提夫林", "ja": "ティーフリング", "es": "Tiefling"},
        "Dragonborn":          {"zh": "龍裔",   "ja": "ドラゴンボーン", "es": "Dracónido"},
        "Gnome":               {"zh": "地精",   "ja": "ノーム",     "es": "Gnomo"},
        "Goblin":              {"zh": "哥布林", "ja": "ゴブリン",   "es": "Goblin"},
        "Leshy":               {"zh": "樹靈",   "ja": "レッシー",   "es": "Leshy"},
        "High Elf":            {"zh": "高等精靈", "ja": "ハイエルフ", "es": "Alto elfo"},
        "Wood Elf":            {"zh": "木精靈", "ja": "ウッドエルフ", "es": "Elfo silvano"},
        # --- Warhammer Fantasy ---
        "Human (Empire)":      {"zh": "人類（帝國）",     "ja": "人間（帝国）",       "es": "Humano (Imperio)"},
        "Human (Bretonnian)":  {"zh": "人類（布列托尼亞）", "ja": "人間（ブレトニア）", "es": "Humano (Bretonia)"},
        # --- Warhammer 40K ---
        "Ogryn":               {"zh": "歐乘人", "ja": "オグリン",   "es": "Ogryn"},
        "Ratling":             {"zh": "鼠人",   "ja": "ラトリング", "es": "Ratling"},
        # --- Shadowrun ---
        "Ork":                 {"zh": "獸人",   "ja": "オーク",     "es": "Orco"},
        "Troll":               {"zh": "巨魔",   "ja": "トロール",   "es": "Trol"},
        # --- Iron Kingdoms ---
        "Gobber":              {"zh": "哥伯",   "ja": "ゴバー",     "es": "Gobber"},
        "Trollkin":            {"zh": "食人妖裔", "ja": "トロールキン", "es": "Trollkin"},
        "Iosan Elf":           {"zh": "伊奧斯精靈", "ja": "イオサンエルフ", "es": "Elfo iosano"},
        "Dwarf (Rhulfolk)":    {"zh": "矮人（盧爾族）", "ja": "ドワーフ（ルール族）", "es": "Enano (Rhulfolk)"},
        "Human (Cygnaran)":    {"zh": "人類（席格納爾）", "ja": "人間（シグナー）", "es": "Humano (Cygnar)"},
        "Human (Khadoran)":    {"zh": "人類（卡多爾）", "ja": "人間（カドル）", "es": "Humano (Khador)"},
        # --- Gloomhaven ---
        "Inox":                {"zh": "犬牛族", "ja": "イノックス", "es": "Inox"},
        "Savvas":              {"zh": "薩瓦斯", "ja": "サヴァス",   "es": "Savvas"},
        "Quatryl":             {"zh": "夸垂爾", "ja": "クアトリル", "es": "Quatryl"},
        "Orchid":              {"zh": "蘭族",   "ja": "オーキッド", "es": "Orchid"},
        "Valrath":             {"zh": "瓦拉斯", "ja": "ヴァルラス", "es": "Valrath"},
        "Aesther":             {"zh": "伊瑟",   "ja": "エーステル", "es": "Aesther"},
        "Harrower":            {"zh": "收割者", "ja": "ハロワー",   "es": "Harrower"},
        # --- Post-Apocalypse ---
        "Human Survivor":      {"zh": "人類倖存者", "ja": "人間サバイバー", "es": "Superviviente"},
        "Mutant":              {"zh": "突變人", "ja": "ミュータント", "es": "Mutante"},
    }

    CLASS_TRANSLATIONS = {
        "Warrior": {"zh": "戰士", "ja": "戦士", "es": "Guerrero"},
        "Mage":    {"zh": "法師", "ja": "魔法使い", "es": "Mago"},
        "Rogue":   {"zh": "盜賊", "ja": "盗賊", "es": "Pícaro"},
        "Cleric":  {"zh": "牧師", "ja": "聖職者", "es": "Clérigo"},
    }

    GENDER_TRANSLATIONS = {
        "Male":       {"zh": "男性",   "ja": "男性",     "es": "Masculino"},
        "Female":     {"zh": "女性",   "ja": "女性",     "es": "Femenino"},
        "Non-binary": {"zh": "非二元", "ja": "ノンバイナリー", "es": "No binario"},
        "Other":      {"zh": "其他",   "ja": "その他",   "es": "Otro"},
    }
