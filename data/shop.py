...
SHOP_CATALOGUE = {
    ...
    'longbow':                 {'price': 300, 'type': 'two_handed', 'atk_bonus': 3,
                                'restricted_to': ['warrior', 'rogue'],
                                'description': "Ranger's longbow (+3 ATK, requires both hands)"},
    'great sword':             {'price': 600, 'type': 'two_handed', 'atk_bonus': 6,
                                'restricted_to': ['warrior'],
                                'description': 'Massive two-handed blade (+6 ATK, requires both hands)'},
    'war hammer':              {'price': 500, 'type': 'two_handed', 'atk_bonus': 5,
                                'restricted_to': ['warrior', 'cleric'],
                                'description': 'Crushing war hammer (+5 ATK, requires both hands)'},
    'battle staff':            {'price': 400, 'type': 'two_handed', 'atk_bonus': 3, 'mp_bonus': 20,
                                'restricted_to': ['mage'],
                                'description': 'Arcane battle staff (+3 ATK, +20 MP, requires both hands)'},

    # ── Shields & Off-Hand (off_hand) ─────────────────────────────────────────
    'steel shield':            {'price': 150, 'type': 'shield', 'def_bonus': 3,
                                'restricted_to': ['warrior', 'cleric'],
                                'description': 'Reliable steel shield (+3 DEF)'},
    'buckler':                 {'price': 120, 'type': 'shield', 'def_bonus': 2,
                                'restricted_to': ['warrior', 'cleric', 'rogue'],
                                'description': 'Light buckler shield (+2 DEF)'},
    'tower shield':            {'price': 350, 'type': 'shield', 'def_bonus': 5,
                                'restricted_to': ['warrior'],
                                'description': 'Full-body tower shield (+5 DEF)'},
    'focus orb':               {'price': 200, 'type': 'off_hand', 'mp_bonus': 15,
                                'restricted_to': ['mage'],
                                'description': 'Arcane focus orb held in off-hand (+15 MP)'},
    'holy tome':               {'price': 180, 'type': 'off_hand', 'mp_bonus': 10,
                                'restricted_to': ['cleric'],
                                'description': 'Sacred scripture for off-hand casting (+10 MP)'},
    'mage tome':               {'price': 280, 'type': 'off_hand', 'mp_bonus': 20,
                                'restricted_to': ['mage'],
                                'description': 'Spellbook of power (+20 max MP)'},
    'spell focus crystal':     {'price': 280, 'type': 'off_hand', 'mp_bonus': 25,
                                'restricted_to': ['mage'],
                                'description': 'Amplifies spell power (+25 max MP)'},

    # ── Helmets (head) ────────────────────────────────────────────────────────
    'leather cap':             {'price': 60,  'type': 'helmet', 'def_bonus': 1,
                                'description': 'Basic leather cap (+1 DEF)'},
    'iron helm':               {'price': 180, 'type': 'helmet', 'def_bonus': 3,
                                'restricted_to': ['warrior', 'cleric'],
                                'description': 'Iron combat helmet (+3 DEF)'},
    'mage hood':               {'price': 140, 'type': 'helmet', 'mp_bonus': 15,
                                'restricted_to': ['mage'],
                                'description': 'Enchanted mage hood (+15 MP)'},
    'rogue hood':              {'price': 100, 'type': 'helmet', 'mov_bonus': 1,
                                'restricted_to': ['rogue'],
