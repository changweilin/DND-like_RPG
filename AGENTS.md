# AGENTS.md — AI Assistant Guide for DND-like RPG

This file provides essential context for AI assistants (Codex, Copilot, etc.)
...
└── .Codex/
    └── settings.local.json # Codex shell permissions
```
